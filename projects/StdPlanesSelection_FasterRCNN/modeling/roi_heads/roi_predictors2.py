...
class MlabelStandardFastRCNNOutput(object):
    ...
    def __init__(self, pred_category_score,
        ...
        # pred results
        self.pred_category_score = pred_category_score
        self.pred_proposal_deltas = pred_proposal_deltas
        self.pred_standard_score = pred_standard_score
    ...
    def losses(self):
        category_cls_loss = self.category_cls_loss()
    ...
    def category_cls_loss(self):
        ...
        if self._no_instances:
            cls_loss = 0.0 * self.pred_category_score.sum()
        else:
            bg_class_id = self.pred_category_score.shape[1] - 1
            ...
            self._log_accuracy(self.pred_category_score, self.gt_classes, suffix='cls_accuracy',
...
class MlabelStandardFastRCNNOutputLayer2(nn.Module):
    """Three branches :
    ...
    def build_std_bone(cls, standard_cls_branch_name, input_shape, emb_dim=512, reduction=8):
        ...
        if standard_cls_branch_name == '2fc':
            ...
            std_cls_branch = nn.Sequential(
                ...
                nn.BatchNorm2d(input_shape.channels),
                nn.ReLU(inplace=True),
                nn.Conv2d(input_shape.channels, input_shape.channels * 2, (1, 1), padding=0, stride=1),
            ...
            std_cls_branch = nn.Sequential(
                ...
                nn.Conv2d(input_shape.channels, input_shape.channels * 2, (1, 1)),
                nn.BatchNorm2d(input_shape.channels * 2),
                nn.ReLU(inplace=True),
    ...
    def forward(self, x, gt_standards=None):
        category_score = self.category_score(x)
        ...
        return category_score, proposal_deltas, standard_score

    def losses(self, predictions, proposals):
        category_score, proposal_deltas, standard_score = predictions
    ...
    def inference(self, predictions, proposals):
        ...
        category_logits, proposal_deltas, standard_logits = predictions
